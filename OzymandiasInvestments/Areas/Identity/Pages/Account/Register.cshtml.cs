...
namespace OzymandiasInvestments.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<OzymandiasInvestmentsUser> _signInManager;
        private readonly UserManager<OzymandiasInvestmentsUser> _userManager;
        private readonly IUserStore<OzymandiasInvestmentsUser> _userStore;
        ...
        public class InputModel
        {
            ...
            [StringLength(255, ErrorMessage = "The last name should be less than 255 characters.")]
        ...
        private OzymandiasInvestmentsUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<OzymandiasInvestmentsUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(OzymandiasInvestmentsUser)}'. " +
                    $"Ensure that '{nameof(OzymandiasInvestmentsUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<OzymandiasInvestmentsUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<OzymandiasInvestmentsUser>)_userStore;
        }
    }
}
